...
import (
	...
	"github.com/auvn/go-examples/example1/frwk-core/apierror"
...
func (s *Server) Handle(msgType string, h message.HandlerFunc) *Server {
	s.handlers.Handle(msgType, h)
	return s
}
...
func Handle(msgType string, h message.HandlerFunc) *Server {
